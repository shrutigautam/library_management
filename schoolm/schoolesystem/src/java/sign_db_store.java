 ...
 * @author Saumya Joshi
 */
@WebServlet(name = "sign_db_store", urlPatterns = {"/sign_db_store"})
public class sign_db_store extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String path=(String)session.getAttribute("path_sign");
        try {
        ...
        int u=stmt.executeUpdate("update images set std_sign=('"+path+"') where admission_no=('"+admn+"')");
        if(u==0){
        ...
        else
        {
            String image=path+admn+".JPG";
                ...
                request.setAttribute("message4",image);
